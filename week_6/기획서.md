...
1. **AI 다자 토론** — 분석가 / 전략가 / 감성케어 **3 페르소나** 동시 응답·한 화면 비교  
2. **클라이언트 소통 스타일 가이드** — 직설 / 데이터 / 우회 **3 응답안**  
3. **Action Plan 요약** — 3 응답 **합성**·클립보드·미팅 노트용  
4. **음성 입출력** — Web Speech **STT** + ElevenLabs **TTS**(서버 프록시)  
5. **대화 기록** — v1 **localStorage** 세션 보존  
